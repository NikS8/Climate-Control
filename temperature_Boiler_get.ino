...
DeviceAddress sensorDsTankIn = { 0x28, 0xFF, 0x9F, 0x65, 0x01, 0x17, 0x04, 0xC9 };    // адрес датчика DS18B20 на трубе в бак
DeviceAddress sensorDsTankOut = { 0x28, 0xFF, 0xAE, 0x35, 0xC1, 0x16, 0x04, 0xCF };    // адрес датчика DS18B20 на трубе из бака
